...
public class KhoanThuChiAdapter2 extends BaseAdapter {
    ...
    public KhoanThuChiAdapter2(ArrayList<KhoanThuChi> list, Context context, KhoanThuChiDAO thuChiDAO, ArrayList<HashMap<String,Object>> listSpinner) {
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewOfItem.ivXoa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(thuChiDAO.xoaKhoanChi(makhoan)){
    ...
    private  void  showDialogSua(KhoanThuChi khoanThuChi){
        ...
        builder.setPositiveButton("cập nhật", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(thuChiDAO.capNhatKhoanChi(khoanThuChi)){
    ...
    private void reloadData(){
        list.clear();
        list = thuChiDAO.getDSKhoanChi("chi");
